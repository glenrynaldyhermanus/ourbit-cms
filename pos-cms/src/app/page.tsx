        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">New order #1234 completed</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Product "Coffee Beans" updated</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Low stock alert: "Tea Bags"</p>
